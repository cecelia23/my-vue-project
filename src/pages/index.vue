...
<div id="index-wrap">
    ...
    <div class="index-left-block lastest-news">
      ...
      <ul>
        <li v-for="item in newList" :key="item.id">
          <a :href="item.url" class="newItem">{{item.title}}</a>
        </li>
      </ul>
    </div>
  ...
  <div class="index-right">
    ...
    <div class="index-board-item"
        ...
        <div class="index-board-item-out">
          <h2>{{item.title}}</h2>
...
export default{
  ...
  created: function () {
    this.$http.get('/api/getNewsList') // 注意get的参数，从模拟后台（api）中取getNewsList对象，而非db
      .then((res) => {
